...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2024 at 02:08 AM
...
CREATE TABLE `tbperfilusuariopersonal` (
  ...
  `tbuniversidadcampus` varchar(50) NOT NULL,
...
(11, 'Gustos Musicales,Actividades Extracurriculares,Hobbies,Religión', 'Rock,Pintura,Lectura,Cristianismo', 'Matemáticas', 'Masculino', 'Heterosexual', 'Universidad Nacional de Costa Rica', 'Campus Coto', 'Volleyball,Fútbol', 12, 1);
...
--
-- Table structure for table `tbsolicitudareaconocimiento`
--

CREATE TABLE `tbsolicitudareaconocimiento` (
  `tbsolicitudareaconocimientoid` int(11) NOT NULL,
  `tbsolicitudareaconocimientonombre` varchar(50) NOT NULL,
  `tbsolicitudareaconocimientoestado` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'Lalalala', 0),
(3, 'Universidad de la prueba', 0),
(4, 'adsf', 0),
(5, 'Universidad Nacional de la prueba', 0),
(6, 'Aqui otraa', 0);
