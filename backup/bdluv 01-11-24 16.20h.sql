...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-11-2024 a las 23:19:06
...
--
-- Volcado de datos para la tabla `tbactividadasistencia`
--

INSERT INTO `tbactividadasistencia` (`tbactividadasistenciaid`, `tbactividadid`, `tbusuarioid`) VALUES
(1, 0, 0),
(2, 0, 0),
(3, 0, 0),
(6, 3, 13),
...
INSERT INTO `tbafinidadusuario` (`tbafinidadusuarioid`, `tbusuarioid`, `tbafinidadusuariogenero`, `tbafinidadusuarioorientacionsexual`, `tbafinidadusuarioestado`) VALUES
(1, 12, '', '', 1),
(0, 14, 'Femenino', 'Heterosexual', 1);
